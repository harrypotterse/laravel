...
<div class="container-fluid" style="height: 100%">
    <div class="container">
        ...
        <form action="{{ route('banner.update', ['id'=>$banner->id]) }}" method="POST" enctype="multipart/form-data">
            {{ method_field('PATCH') }}
            @csrf
            <input type="hidden" value="{{ $banner->Image}}" name="old">
            <div class="row">
                <div class="input-field col s6">
                  <input id="Title" type="text" class="validate" name="Title" value="{{ $banner->Title}}">
        ...
        <img class="responsive-img img-thumbnail" width="150"
            src="{{Request::root()}}{{ $path }}{{ $banner->Image}}">
