...
<div class="content">
    ...
    <table class="table table-bordered table-hover table-responsive content">
        ...
        <tbody>
            ...
            @foreach ($portfolio as $item_customers)
            <tr class="hed">
                ...
                <td>{{ $item_customers->sectionspro[0]->sections}}</td>
                <td>{!! set_lab_lang($item_customers->Language) !!}</td>
                <td>
                    <a rel="tooltip" href="{{ route('portfolio.edit', ['id'=>$item_customers->id]) }}"
                    ...
                    <button type="button" idt="{{ $item_customers->id}}" idm="{{ $item_customers->Image}}"
                        route="{{ route('portfolio.destroy.dell', ['id'=>$item_customers->id,'img'=>$item_customers->Image]) }}"
    ...
    <br>
    <a style="background: #011a25;" href="{{ route('portfolio.create') }}" class="btn btn-primary btn-block btn-large">
