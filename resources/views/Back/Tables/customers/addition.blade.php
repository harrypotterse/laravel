...
<div class="container-fluid" style="height: 100%">
  <div class="container">
      ...
      <br>
      <br>
    <form action="{{route('save.customers')}}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="row">
        <label>اللغة</label>
      ...
      <div class="row">
        <div class="input-field col s6">
          <input id="Name" type="text" class="validate" name="Name" value="{{Request::old('Facebook')}}">
      ...
      <div class="row">
        <div class="input-field col s12">
          <textarea id="textarea1" class="materialize-textarea" name="Word">{{Request::old('Name')}}</textarea>
      ...
      <div class="row">
        <div class="input-field col s6">
          <input id="Facebook" type="text" class="validate" name="Facebook" value="{{Request::old('Facebook')}}">
          <label class="active" for="Facebook">الفيس بوك</label>
          @if ($errors->has('Facebook'))
          <span class="helper-text" data-error="wrong" data-success="right">{{ $errors->first('Facebook') }}</span>
          @endif
        </div>
      </div>
