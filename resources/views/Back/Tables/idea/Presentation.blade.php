...
<div class="content">
            ...
            <tr class="hed">
                ...
                <td>
                    ...
                    <button type="button" idt="{{ $item_customers->id}}" idm="{{ $item_customers->Image}}"
                        route="{{ route('idea.destroy.dell', ['id'=>$item_customers->id]) }}"
    ...
    <br>
    <a style="background: #011a25;" href="{{ route('idea.create') }}" class="btn btn-primary btn-block btn-large">
