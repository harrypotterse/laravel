...
<div class="container-fluid" style="height: 100%">
  <div class="container">
    ...
    <br>
    <br>
    <form action="{{route('sections_pro.store')}}" method="POST" enctype="multipart/form-data">
      @csrf
      {{--  #####################################################################################  --}}
      <div class="row">
        <label>اللغة</label>
      ...
      <div class="row">
          <div class="input-field col s6">
            <input id="sections" type="text" class="validate" name="sections" value="{{Request::old('sections')}}">
            <label class="active" for="sections">القسم</label>
